...
namespace FilmesAPI
{
    public class Startup
    {
        ...
        {
            //Criação do serviço de conexão com o banco de dados
            ...
            services.AddScoped<FilmeService, FilmeService>();//Adicionando ao escopo para que seja possivel fazer a Injeção de Dependencia
            ...
            //Especifica que usaremos o Automapper dentro do Assemble da nossa aplicação
