...
namespace UsuariosAPI.Models
{
    ...
    {
        //Esse Tipo é do MimeKit, ele identifica um endereço de email
        ...
        public Mensagem(IEnumerable<string> destinatario, string assunto, int usuarioId, string codigo)
        {
            ...
            Destinatario.AddRange(destinatario.Select(d => new MailboxAddress(d))); //Add nosso user na lista de Destinatario
            Assunto = assunto;
